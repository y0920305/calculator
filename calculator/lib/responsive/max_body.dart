...
class MyMaxBody extends StatefulWidget {
  const MyMaxBody({Key? key}) : super(key: key);

  @override
  _MyMaxBodyState createState() => _MyMaxBodyState();
}

class _MyMaxBodyState extends State<MyMaxBody> {
  /* String result = '';
  String equation = '';
  String expression = '';
